...
BOT_TOKEN = const.token
CHANNEL_NAME = '@test_fit_table_bot'


# настройки для журнала
logger = logging.getLogger('log')
logger.setLevel(logging.INFO)
fh = logging.FileHandler('vkpostTestBot.log')
...
URL_VK = 'https://api.vk.com/method/wall.get?domain=fititb&count=10&filter=owner'
FILENAME_VK = 'last_known_id.txt'
BASE_POST_URL = 'https://vk.com/wall-24770985_'
